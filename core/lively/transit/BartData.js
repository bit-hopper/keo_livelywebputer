...
module("lively.transit.BartData")
  ...
  .toRun(function () {
    ...
    lively.transit.BartData = {
      ...
      // abbr -> { name, lat, lon }
      stations: {
        "12TH": { name: "12th St. Oakland City Center", lat: 37.803768, lon: -122.271450 },
        "16TH":  { name: "16th St. Mission",              lat: 37.765062, lon: -122.419694 },
        "19TH":  { name: "19th St. Oakland",               lat: 37.808350, lon: -122.268602 },
        "24TH":  { name: "24th St. Mission",               lat: 37.752470, lon: -122.418143 },
        "ANTC":  { name: "Antioch",                        lat: 37.995388, lon: -121.780420 },
        "ASHB":  { name: "Ashby",                          lat: 37.852803, lon: -122.270062 },
        "BALB":  { name: "Balboa Park",                    lat: 37.721585, lon: -122.447506 },
        "BAYF":  { name: "Bay Fair",                       lat: 37.696924, lon: -122.126514 },
        "BERY":  { name: "Berryessa/North San Jose",       lat: 37.368473, lon: -121.874681 },
        "CAST":  { name: "Castro Valley",                  lat: 37.690746, lon: -122.075602 },
        "CIVC":  { name: "Civic Center/UN Plaza",          lat: 37.779732, lon: -122.414123 },
        "COLS":  { name: "Coliseum",                       lat: 37.753661, lon: -122.196869 },
        "COLM":  { name: "Colma",                          lat: 37.684638, lon: -122.466233 },
        "CONC":  { name: "Concord",                        lat: 37.973737, lon: -122.029095 },
        "DALY":  { name: "Daly City",                      lat: 37.706121, lon: -122.469081 },
        "DBRK":  { name: "Downtown Berkeley",               lat: 37.870104, lon: -122.268133 },
        "DUBL":  { name: "Dublin/Pleasanton",              lat: 37.701687, lon: -121.899179 },
        "DELN":  { name: "El Cerrito del Norte",           lat: 37.925086, lon: -122.316794 },
        "PLZA":  { name: "El Cerrito Plaza",                lat: 37.902632, lon: -122.298904 },
        "EMBR":  { name: "Embarcadero",                    lat: 37.792874, lon: -122.397020 },
        "FRMT":  { name: "Fremont",                        lat: 37.557465, lon: -121.976608 },
        "FTVL":  { name: "Fruitvale",                      lat: 37.774836, lon: -122.224175 },
        "GLEN":  { name: "Glen Park",                      lat: 37.733064, lon: -122.433817 },
        "HAYW":  { name: "Hayward",                        lat: 37.669723, lon: -122.087018 },
        "LAFY":  { name: "Lafayette",                      lat: 37.893176, lon: -122.124630 },
        "LAKE":  { name: "Lake Merritt",                   lat: 37.797027, lon: -122.265180 },
        "MCAR":  { name: "MacArthur",                      lat: 37.829065, lon: -122.267040 },
        "MLBR":  { name: "Millbrae",                       lat: 37.600271, lon: -122.386702 },
        "MLPT":  { name: "Milpitas",                       lat: 37.410277, lon: -121.891081 },
        "MONT":  { name: "Montgomery St.",                 lat: 37.789405, lon: -122.401066 },
        "NBRK":  { name: "North Berkeley",                 lat: 37.873967, lon: -122.283440 },
        "NCON":  { name: "North Concord/Martinez",         lat: 38.003193, lon: -122.024653 },
        "OAKL":  { name: "Oakland International Airport",  lat: 37.713238, lon: -122.212191 },
        "ORIN":  { name: "Orinda",                         lat: 37.878361, lon: -122.183791 },
        "PITT":  { name: "Pittsburg/Bay Point",            lat: 38.018914, lon: -121.945154 },
        "PCTR":  { name: "Pittsburg Center",                lat: 38.016941, lon: -121.889457 },
        "PHIL":  { name: "Pleasant Hill/Contra Costa Centre", lat: 37.928468, lon: -122.056012 },
        "POWL":  { name: "Powell St.",                     lat: 37.784471, lon: -122.407974 },
        "RICH":  { name: "Richmond",                       lat: 37.936853, lon: -122.353099 },
        "ROCK":  { name: "Rockridge",                      lat: 37.844702, lon: -122.251371 },
        "SBRN":  { name: "San Bruno",                      lat: 37.637761, lon: -122.416287 },
        "SFIA":  { name: "San Francisco International Airport", lat: 37.615966, lon: -122.392409 },
        "SANL":  { name: "San Leandro",                    lat: 37.721947, lon: -122.160844 },
        "SHAY":  { name: "South Hayward",                  lat: 37.634375, lon: -122.057189 },
        "SSAN":  { name: "South San Francisco",            lat: 37.664245, lon: -122.443960 },
        "UCTY":  { name: "Union City",                     lat: 37.590630, lon: -122.017388 },
        "WCRK":  { name: "Walnut Creek",                   lat: 37.905522, lon: -122.067527 },
        "WARM":  { name: "Warm Springs/South Fremont",     lat: 37.502171, lon: -121.939313 },
        "WDUB":  { name: "West Dublin/Pleasanton",         lat: 37.699756, lon: -121.928240 },
        "WOAK":  { name: "West Oakland",                   lat: 37.804872, lon: -122.295140 },
      },
