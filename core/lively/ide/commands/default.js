module("lively.ide.commands.default")
  .requires()
  .toRun(function () {
      ...
      getCommands: function (context) {
        ...
        function printBoundKeys(bindKey) {
          ...
          if (typeof bindKey === "string")
            return bindKey.replace(/([^\s])\|([^\s])/g, "$1 | $2");
          if (Array.isArray(bindKey))
            return bindKey.map(printBoundKeys).join(" | ");
        ...
        function getCodeEditorCommands(codeEditor) {
          var shortcutMgr =
              lively.ide.CodeEditor.KeyboardShortcuts.defaultInstance(),
          ...
          return cmdNames.reduce(function (cmds, cmdName) {
            ...
            cmds[cmdName] = lively.lang.obj.merge(cmd, {
              exec: function (args) {
                cmd.exec(codeEditor.aceEditor, args);
              },
    ...
    Object.extend(lively.ide.commands.byName, {
      "lively.morphic.World.saveLocalCopy": {
        ...
        exec: function () {
          ...
          var url =
            world.getUserDir().toString() +
            document.location.pathname.split("/").last();
      ...
      "lively.morphic.World.escape": {
        ...
        exec: function () {
          ...
          var world = lively.morphic.World.current(),
            h = world.firstHand();
          if (h.submorphs.length > 0) {
            h.dropContentsOn(world);
            return true;
          }
          if (world.worldMenuOpened) {
            h.removeOpenMenu();
            return true;
          }
          ...
          if (world.currentHaloTarget) {
            world.removeHalosOfCurrentHaloTarget();
            return true;
          }
          var narrowers = world.submorphs.filter(function (m) {
            return m.isNarrowingList && m.isVisible();
          });
          if (narrowers.length) {
            narrowers.invoke("deactivate");
            return true;
          }
          var focused = lively.morphic.Morph.focusedMorph();
          if (focused && focused._statusMorph && focused._statusMorph.world()) {
            focused.removeStatusMessage();
            return true;
          }
          var statusMessages =
            lively.morphic.StatusMessage &&
            $world.withAllSubmorphsSelect(function (ea) {
              return ea instanceof lively.morphic.StatusMessage;
            });
          if (statusMessages && statusMessages.length) {
            statusMessages.invoke("remove");
            return true;
          }
          return false;
        },
      ...
      "lively.morphic.World.undoLastAction": {
        ...
        exec: function () {
          ...
          if (
            lively.morphic.Morph.focusedMorph() instanceof
              lively.morphic.Text ||
            lively.morphic.Morph.focusedMorph() instanceof
      ...
      "lively.morphic.World.setExtent": {
        ...
        // Modified to automatically fill the entire screen by default instead of prompting
        // This ensures the morphic world always maximizes to available viewport dimensions
        exec: function () {
          // Get the current window/viewport bounds (viewport width and height in screen coordinates)
          var windowBounds = $world.windowBounds();
          // Extract just the extent (width, height) from the bounds rectangle
          var fullScreenExtent = windowBounds.extent();
          // Apply the new extent to the world, making it fill the entire visible screen
          $world.setExtent(fullScreenExtent);
          // Provide user feedback that the operation completed successfully
          alertOK(
            "World extent automatically set to fill screen: " +
              fullScreenExtent,
          );
        },
      },
      ...
      "lively.morphic.Morph.showSceneGraph": {
        ...
        exec: function () {
          ...
          var results = [],
            preselect = $world.currentHaloTarget,
            i = 0,
            preselectIndex = 0;
          var candidates = withSubmorphsDoWhenTruthy(
            $world,
            function (ea, depth) {
              if (ea.isNarrowingList) return null;
              if (ea === preselect) preselectIndex = i;
              i++;
          ...
          lively.ide.tools.SelectionNarrowing.getNarrower({
            ...
            setup: function (narrower) {
              lively.bindings.connect(narrower, "selection", Global, "show", {
              ...
              actions: [
                {
                  name: "show halos",
                  exec: function (morph) {
                    morph.focus.bind(morph).delay(0.1);
                    morph.showHalos();
                  },
                },
                {
                  name: "inspect",
                  exec: function (morph) {
                    lively.morphic.inspect(morph);
                  },
                },
                {
                  name: "open ObjectEditor",
                  exec: function (morph) {
                    lively.morphic.edit(morph);
                  },
                },
                {
                  name: "open StyleEditor",
                  exec: function (morph) {
                ...
                },
                {
                  ...
                  exec: function (morph) {
                    var copy = morph.copy();
                    morph.owner.addMorph(copy, morph);
                    morph.showHalos();
                    morph.focus();
                  },
                },
      ...
      "lively.morphic.Morph.alignFlapsInWorld": {
        ...
        exec: function () {
          $world.submorphs
            .filter(function (ea) {
              return ea.hasFixedPosition() && ea.alignInWorld;
            })
            .invoke("alignInWorld");
          return true;
        },
          ...
          if (spacing) lively.Config.set("gridSpacing", spacing);
            ...
            $world.prompt(
              ...
              function (input) {
                var n = Number(input);
                if (!n || isNaN(n))
                  $world.inform('Not a valid input: "' + input + '"');
      ...
      "lively.morphic.Window.rename": {
        ...
        exec: function () {
          ...
          if (!win) {
            show("Cannot find active window!");
            return;
          }
          $world.prompt(
      ...
      "lively.morphic.Window.rearrangeSelectedIntoVisibleBounds": {
        description:
          "morphic: Rearrange selected morphs to fit into visible world bounds.",
        exec: function () {
          function fitMorphsIntoBounds(morphs, bounds) {
            ...
            var morphBounds = morphs.invoke("globalBounds"),
              morphBoundsCombined = morphBounds.inject(
                morphBounds[0],
                function (combinedBounds, eaBounds) {
                  return combinedBounds.union(eaBounds);
                },
              ),
              offsetTopLeft = bounds
                .topLeft()
                .subPt(morphBoundsCombined.topLeft()),
              scalePoint = bounds
                .extent()
                .scaleByPt(morphBoundsCombined.extent().inverted());
            morphs.forEach(function (ea) {
              ea.setPosition(
                ea.getPosition().scaleByPt(scalePoint).addPt(offsetTopLeft),
              );
            });
          }
          var morphs = $world.getSelectedMorphs();
          if (!morphs || !morphs.length) {
            alert("No morph selected!");
            return;
          }
          ...
          function doResize(how) {
            switch (how) {
              ...
              case "fullscreen":
                break;
              case "center":
                bounds = thirdColBounds.withCenter(worldB.center());
                break;
              case "right":
                bounds = thirdColBounds.withTopRight(worldB.topRight());
                break;
              case "left":
                bounds = thirdColBounds.withTopLeft(bounds.topLeft());
                break;
              case "col3":
              case "center":
                bounds = thirdColBounds.withCenter(worldB.center());
              ...
              case "left":
                ...
                break;
              case "bottom":
                bounds = bounds.withY(bounds.y + bounds.height / 2);
              case "top":
                bounds = bounds.withHeight(bounds.height / 2);
                break;
              case "col2":
                bounds = thirdColBounds
                  .withTopLeft(worldB.topCenter().scaleByPt(pt(0.333, 1)))
                  .withWidth(thirdW);
                break;
              case "col4":
                bounds = thirdColBounds
                  .withTopRight(worldB.topCenter().scaleByPt(pt(1.666, 1)))
                  .withWidth(thirdW);
                break;
              case "halftop":
                bounds = winB.withY(bounds.top()).withHeight(bounds.height / 2);
                break;
              case "halfbottom":
                bounds = winB
                  .withY(bounds.height / 2)
                  .withHeight(bounds.height / 2);
                break;
              case "reset":
                bounds =
                  win.normalBounds ||
                  pt(500, 400).extentAsRectangle().withCenter(bounds.center());
                break;
              default:
                return;
            }
      ...
      "lively.ide.resizeWindow.reset": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "reset");
        },
      },
      "lively.ide.resizeWindow.full": {
        exec: function () {
          return lively.ide.commands.exec(
            "lively.ide.resizeWindow",
            "fullscreen",
          );
        },
      },
      "lively.ide.resizeWindow.left": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "left");
        },
      },
      "lively.ide.resizeWindow.center": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "center");
        },
      },
      "lively.ide.resizeWindow.right": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "right");
        },
      },
      "lively.ide.resizeWindow.top": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "top");
        },
      },
      "lively.ide.resizeWindow.bottom": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "bottom");
        },
      },
      "lively.ide.resizeWindow.col1": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "col1");
        },
      },
      "lively.ide.resizeWindow.col2": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "col2");
        },
      },
      "lively.ide.resizeWindow.col3": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "col3");
        },
      },
      "lively.ide.resizeWindow.col4": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "col4");
        },
      },
      "lively.ide.resizeWindow.col5": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "col5");
        },
      },
      "lively.ide.resizeWindow.halftop": {
        exec: function () {
          return lively.ide.commands.exec("lively.ide.resizeWindow", "halftop");
        },
      },
      "lively.ide.resizeWindow.halfbottom": {
        exec: function () {
          return lively.ide.commands.exec(
            "lively.ide.resizeWindow",
            "halfbottom",
      ...
      "lively.morphic.Window.resizeVisibleMorphsToFitIntoVisibleBounds": {
        description:
          "morphic: Resize visible morphs to fit into visible world bounds.",
        exec: function () {
          $world.submorphs.forEach(function (ea) {
            var vB = $world.visibleBounds(),
              b = ea.bounds();
            if (
              !vB.containsPoint(b.topLeft()) ||
              vB.containsPoint(b.bottomRight())
            )
              return;
            ea.setBounds(
              rect(b.topLeft(), b.bottomRight().minPt(vB.bottomRight())),
            );
          });
          return true;
        },
      ...
      "lively.morphic.Window.selectAll": {
        ...
        exec: function () {
          var windows = $world.submorphs.select(function (ea) {
            return ea.isWindow;
          });
      ...
      "lively.ide.WindowNavigation.reopenClosedWindows": {
        ...
        exec: function () {
          var narrower = $world.submorphs.detect(function (morph) {
            return (
              morph.name &&
              morph.name.include("lively.ide.WindowNavigation.NarrowingList")
            );
          });
          if (narrower) {
            narrower.state.allCandidates
              .pluck("value")
              .reverse()
              .invoke("openInWorld");
      ...
      "lively.ide.commands.keys.toggleShowPressedKeys": {
        ...
        exec: function () {
          ...
          if (inspector) inspector.remove();
            ...
            inspector = lively.PartsBin.getPart(
              "KeyPressInspector",
              "PartsBin/Debugging/",
            );
            inspector.openInWorld();
            inspector.align(
              inspector.bounds().bottomRight(),
              $world.visibleBounds().bottomRight(),
            );
      ...
      "lively.ide.codeditor.addCompletions": {
        ...
        exec: function (string) {
          ...
          require("lively.ide.codeeditor.Completions").toRun(function () {
            var words =
              lively.ide.codeeditor.Completions.addWordsFromString(string);
            alertOK("added words");
          });
          return true;
        },
      ...
      "lively.ide.codeditor.browseWarningsAndErrorsInCodeEditor": {
        ...
        exec: function (opts) {
          ...
          var markers = focused.getSession()
            ? focused.getSession()["$ext.lang.codeMarker"]
            : null;
      ...
      "lively.ide.tools.SelectionNarrowing.activateLastActive": {
        ...
        exec: function () {
          var n =
            ...
            lively.ide.tools.SelectionNarrowing.lastActive;
          n && n.activate();
        },
      },
      ...
      "lively.ide.evalJavaScript": {
        ...
        exec: function () {
          var dlg = $world.editPrompt(
            "Enter JavaScript code to evaluate",
            function (input) {
        ...
        exec: true
          ? function browseFilesWithFind() {
              var actions = [
                {
                  ...
                  exec: function (candidate) {
                    if (isSaveForSCB(candidate))
                      lively.ide.browse(
                        URL.root.withFilename(candidate.relativePath),
                      );
                ...
                },
                {
                  ...
                  exec: function (candidate) {
                    lively.ide.openFile(candidate.fullPath);
                  },
                },
                {
                  name: "open in web browser",
                  exec: function (candidate) {
                    window.open(candidate.relativePath);
                  },
                },
                {
                  name: "open in versions viewer",
                  exec: function (candidate) {
                    lively.ide.commands.exec(
                      "lively.ide.openVersionsViewer",
                      candidate.relativePath,
                    );
                  },
                },
                {
                  name: "reset directory watcher",
                  exec: function (candidate) {
              ...
              var showsInitialCandidates = true,
                initialCandidates = [],
                searchForMatchingDebounced = lively.lang.fun.debounce(
                  1000,
                  searchForMatching,
                ),
              ...
              function isSaveForSCB(candidate) {
                return (
                  !!candidate && (candidate.fullPath || "").endsWith(".js")
                );
              }
              ...
              function doSearch(searchAgain, input, matchParts, thenDo) {
                lively.lang.fun.composeAsync(
                  function withDirDo(func) {
                    func(null, lively.shell.cwd());
                  },

                  function fetchFiles(dir, next) {
                    if (!searchAgain && lastFiles)
                      return next(null, lastFiles, dir);
                    ...
                    lively.ide.CommandLineSearch.findFiles(
                      input,
                      opts,
                      function (err, files, cmd) {
                        if (cmd.isOutdated) return next(ignoreResult);
                        else if (err)
                          next(
                            new Error(
                              "Cannot fetch files for " + dir + ":\n" + err,
                            ),
                          );
                        else {
                          lastFiles = files;
                  ...
                  function (files, dir, next) {
                    var paths = files
                      ...
                      .filter(function (ea) {
                        return lastMatchParts.every(function (match) {
                          return match.test(ea);
                        });
                      });
                    next(null, paths, dir);
                  },
                  ...
                  function (files, dir, next) {
                    next(null, makeCandidates(dir, files));
                  },
          ...
          : // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
            ...
            function browseFilesWithDirWatcher() {
              ...
              var dir,
                ...
                narrower =
                  lively.ide.tools.SelectionNarrowing.getNarrower(spec);
              ...
              function update(candidates, narrower, thenDo) {
                ...
                Functions.composeAsync(
                  ...
                  function fetchFiles(isRetry, dir, next) {
                    lively.ide.DirectoryWatcher.withFilesOfDir(
                      dir,
                      function (files) {
                ...
                function withDirDo(func) {
                  if (narrower & narrower.dir) func(null, narrower.dir);
                    ...
                    lively.shell.exec("pwd", {}, function (cmd) {
                      func(null, cmd.resultString());
                    });
                }
      ...
      "lively.ide.SystemCodeBrowser.browseModule": {
        ...
        exec: function (moduleNameOrFileOrURL) {
          ...
          function doPrompt(thenDo) {
            $world.prompt(
              "Which module to browse?",
              function (name) {
                thenDo(name);
              },
              {
                historyId: "lively.ide.SystemCodeBrowser.browseModule",
                input: "lively.Base",
              },
            );
          }
          ...
          function doBrowse(moduleNameOrFileOrURL) {
            if (URL.isURL(moduleNameOrFileOrURL)) {
              ...
              moduleNameOrFileOrURL.endsWith(".js") ||
              moduleNameOrFileOrURL.include("/")
            ) {
              var wrapper = lively.ide.ModuleWrapper.forFile(
                  moduleNameOrFileOrURL,
                ),
                fn = wrapper.fileName();
      ...
      "lively.ide.SystemCodeBrowser.browseModuleStructure": {
        ...
        exec: function () {
          var win = $world.getActiveWindow(),
            ...
            ff =
              browser &&
              browser.getPane1Selection() &&
              browser.getPane1Selection().target;
          if (!ff) {
            show("No browser active or no module selected!");
            return false;
          }
          function withSubelementsOfFFDo(ff, func, context, depth) {
            ...
            ff.subElements().forEach(function (ff) {
              results.pushAll(
                withSubelementsOfFFDo(ff, func, context, depth + 1),
              );
            });
            return results;
          }
          ...
          var candidates = withSubelementsOfFFDo(ff, function (ff, depth) {
            ...
            string = Strings.indent(string, "  ", depth);
            return ff.name
              ? { isListItem: true, string: string, value: ff }
              : null;
          }).compact();
      ...
      "lively.ide.resourceSearch": {
        ...
        exec: function (optSearchTerm) {
          if (optSearchTerm) doSearch(optSearchTerm);
            ...
            $world.prompt(
              "Search for world, part, or file matching:",
              function (input) {
          ...
          function doSearch(searchTerm) {
            ...
            Functions.composeAsync(
              ...
              function (next) {
                lively.net.Wiki.findResourcePathsMatching(
                  searchTerm,
                  true,
                  next,
                );
              ...
              function (results, next) {
                lively.net.Wiki.openResourceList(
                  results,
      ...
      "lively.ide.CommandLineInterface.doGrepSearch": {
        ...
        exec: function () {
          var lastSearchTime,
            fileTypes = [],
            greper = lively.lang.fun.debounce(
              500,
              function (t, input, callback) {
                lively.ide.CommandLineSearch.doGrep(
                  input,
                  null,
                  { fileTypes: fileTypes },
          ...
          lively.lang.fun.composeAsync(
            ...
            err && $world.inform(err.stack || err);
          });
          ...
          function openInSCB(candidate) {
            if (Object.isString(candidate)) return;
            lively.ide.CommandLineSearch.doBrowseGrepString(
              candidate.match,
              candidate.baseDir,
            );
          }
          ...
          function selectFileTypes(thenDo) {
            $world.prompt(
              "What kinds of files to search (separate by space)?",
              function (input) {
              ...
              },
              {
                ...
                useLastInput: true,
                historyId:
                  "lively.ide.CommandLineInterface.doGrepSearch.file-type-prompt",
              },
            );
          }
                ...
                actions: [
                  {
                    ...
                    exec: function (candidate) {
                      if (Object.isString(candidate)) return;
                      var isLively =
                        candidate.match.match(/\.?\/?core\//) &&
                        candidate.baseDir.match(/\.?\/?/);
                  ...
                  },
                  {
                    ...
                    exec: function () {
                      var state = narrower.state,
                        content = narrower
                          .getFilteredCandidates(state.originalState || state)
                          .pluck("match")
                          .join("\n"),
        ...
        exec: function () {
          lively.lang.fun.composeAsync(
            ...
            function chooseFromKnownWorkingDirectories(n) {
              if (
                !$world.knownWorkingDirectories ||
                !$world.knownWorkingDirectories.length
              )
                return n(null, null);
              lively.ide.tools.SelectionNarrowing.getNarrower({
                name: "lively.ide.CommandLineInterface.changeShellBaseDirectory.chooseKnown",
                spec: {
                  candidates: ["choose different directory..."].concat(
                    knownDirectories(),
                  ),
                  preselect: 1,
                  actions: [
                    ...
                    function remove(c) {
                      var path =
                        (c && (Object.isString(c) ? c : c.path)) || null;
            ...
            function chooseNewDir(dir, n) {
              ...
              lively.ide.CommandLineSearch.interactivelyChooseFileSystemItem(
                ...
                function (files) {
                  return files.filterByKey("isDirectory");
                },
            ...
            function setBasePath(candidate, n) {
              ...
              var path =
                (candidate &&
                  (Object.isString(candidate) ? candidate : candidate.path)) ||
                null;
              ...
              lively.Config.get("lively.lang.Runtime.active") &&
                path &&
          ...
          function knownDirectories() {
            return ($world.knownWorkingDirectories || []).uniqBy(
              function (a, b) {
      ...
      "lively.ide.CommandLineInterface.openBaseDirectoryChooser": {
        ...
        exec: function () {
          require("lively.ide.tools.BaseDirectoryChooser").toRun(function () {
            lively
              .BuildSpec("lively.ide.tools.BaseDirectoryChooser")
              .createMorph()
              .openInWorldCenter()
              .comeForward();
          });
        ...
        exec: function (opts) {
          ...
          function printIt(dir) {
            ...
            lively.lang.fun.composeAsync(
              function (n) {
                lively
                  .require("lively.data.DirectoryUpload")
                  .toRun(function () {
                    n();
                  });
              },
              function (n) {
                var excludes = lively.lang.string.format(
                    "\\( -iname %s \\) -prune -o",
                    lively.Config.codeSearchGrepExclusions
                      .map(Strings.print)
                      .join(" -o -iname "),
                  ),
                  cmdString = lively.lang.string.format(
                    "find %s %s -print",
              ...
              function (cmd, n) {
                n(null, cmd.getStdout().split("\n"));
              },
            )(function (err, files) {
              if (err)
                $world.inform(
                  "Error printing dir hierarchy of " + dir.path + "\n" + err,
                );
              else
                new lively.data.DirectoryUpload.Handler().printFileNameListAsTree(
                  files,
                  "Directory hierarchy of " + dir,
                );
            });
          }
        },
      ...
      "lively.ide.execShellCommand": {
        ...
        exec: function (codeEditor, args) {
          var insertResult =
              !args || typeof args.insert === "undefined" || !!args.insert,
            showProgress = args && !!args.showProgress,
            openInWindow =
              !codeEditor || (args && args.count !== 4) /*universal argument*/,
          ...
          function ensureCodeEditor(title) {
            ...
            if (!openInWindow && codeEditor && codeEditor.isCodeEditor)
              return codeEditor;
          ...
          function runCommand(command) {
            ...
            cmd = ed.currentShellCommand = lively.shell.run(
              command,
              { addToHistory: addToHistory, group: group },
              function (err, cmd) {
      ...
      "lively.ide.execShellCommandInWindow": {
        ...
        exec: function () {
          require("lively.ide.tools.ShellCommandRunner").toRun(function () {
            lively
              .BuildSpec("lively.ide.tools.ShellCommandRunner")
              .createMorph()
              .openInWorldCenter()
              .comeForward();
          });
              ...
              actions: [
                {
                  ...
                  exec: function (cmd) {
                    require("lively.ide.tools.ShellCommandRunner").toRun(
                      function () {
                        lively.ide.tools.ShellCommandRunner.forCommand(cmd)
                          .openInWorldCenter()
                          .comeForward();
                      },
                    );
                ...
                },
                {
                  name: "kill command",
                  exec: function (cmd) {
                    cmd.kill("SIGKILL", function () {
                      show("kill signal send");
                    });
                  },
                },
              ],
      ...
      "lively.ide.CommandLineInterface.showRunningShellCommands": {
        ...
        exec: function (opts) {
          ...
          ed.addScript(function update() {
            ...
            var output = groups
              .reject(function (g) {
                return !q[g] || !q[g].length;
              })
              .map(function (group) {
                return printGroup(group, q[group]);
              })
              .join("\n\n");
      ...
      "lively.ide.openWorkspace": {
        ...
        exec: function (options) {
          options = options || {};
          return lively
            .module("lively.ide.tools.JavaScriptWorkspace")
            .load()
            .then(function () {
      ...
      "lively.ide.openTextWindow": {
        description: "open Text window",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openTextWindow();
          return true;
        },
      },
      "lively.ide.openSystemCodeBrowser": {
        description: "open SystemCodeBrowser",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
      ...
      "lively.ide.openObjectEditor": {
        description: "open ObjectEditor",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
      ...
      "lively.ide.openBuildSpecEditor": {
        description: "open BuildSpecEditor",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openBuildSpecEditor();
          return true;
        },
      },
      "lively.ide.openWorldCSSEditor": {
        description: "open CSS Editor",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openWorldCSSEditor();
          return true;
        },
      },
      "lively.ide.openTestRunner": {
        description: "open TestRunner",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openTestRunner();
          return true;
        },
      },
      "lively.ide.openMethodFinder": {
        description: "open MethodFinder",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openReferencingMethodFinder();
          return true;
        },
      },
      "lively.ide.openTextEditor": {
        description: "open TextEditor",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function (path) {
          lively.ide.openFile(path || URL.source.toString());
          return true;
        },
      },
      "lively.ide.openSystemConsole": {
        ...
        exec: function () {
          if ($world.get("LogMessages"))
            $world.get("LogMessages").comeForward();
          else
      ...
      "lively.ide.logging.toggleVerbosity": {
        ...
        exec: function () {
          ...
          show(
            "verbose logging %sactivated",
            lively.Config.get("verboseLogging") ? "" : "de",
          );
          return true;
        },
      },
      ...
      "lively.ide.openServerProcessViewer": {
        ...
        exec: function () {
          lively
            .require("lively.ide.tools.ServerProcessViewer")
            .toRun(function () {
      ...
      "lively.ide.openOMetaWorkspace": {
        description: "tools: open OMetaWorkspace",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openOMetaWorkspace();
          return true;
        },
      },
      ...
      "lively.ide.openServerWorkspace": {
        description: "tools: open ServerWorkspace",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openServerWorkspace();
          return true;
        },
      },
      "lively.ide.openShellWorkspace": {
        description: "tools: open ShellWorkspace",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          var codeEditor = $world
            .addCodeEditor({
              textMode: "sh",
              theme: "clouds",
              title: "Shell Workspace",
              content: "# You can evaluate shell commands in here\nls $PWD",
            })
            .getWindow()
            .comeForward();
          return true;
      ...
      "lively.ide.openVersionsViewer": {
        description: "tools: open VersionsViewer",
        exec: function (path) {
          $world.openVersionViewer(path);
          return true;
        },
      },
      "lively.ide.openServerLog": {
        description: "logging: open JavaScript server log",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          require("lively.ide.tools.ServerLog").toRun(function () {
            lively.ide.tools.ServerLog.open();
          });
          return true;
        },
      },
      "lively.ide.openDiffer": {
        description: "tools: open text differ",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          require("lively.ide.tools.Differ").toRun(function () {
            lively
              .BuildSpec("lively.ide.tools.Differ")
              .createMorph()
              .openInWorldCenter()
              .comeForward();
          });
      ...
      "lively.ide.showWikiFlap": {
        ...
        exec: function (path) {
          require("lively.net.tools.Wiki").toRun(function () {
            lively
              .BuildSpec("lively.wiki.ToolFlap")
              .createMorph()
              .openInWorld();
          });
          return true;
      ...
      "lively.ide.diffWorkspaces": {
        ...
        exec: function (editor1, editor2) {
          ...
          function fetchEditorsIfRequired(next) {
            if (!editor1 || !editor2)
              editors = $world
                .withAllSubmorphsSelect(function (ea) {
                  return ea.isCodeEditor && !ea.isCommandLine;
                })
                .reverse();
            next(null);
          }
          ...
          function selectEditor2(editor1, next) {
            if (editor2) next(null, editor1, editor2);
              ...
              selectMorph(editors.without(editor1), function (err, editor2) {
          ...
          function doDiff(ed1, ed2, next) {
            ...
            lively.ide.diffNonInteractiveIgnoringWhitespace(
              fn,
              ed1.textString,
              ed2.textString,
              function (err, diff) {
        ...
        exec: function (morph1, morph2) {
          ...
          function selectMorph2(morph1, next) {
            if (morph2) next(null, morph1, morph2);
              ...
              selectMorph(morphs.without(morph1), function (err, morph2) {
                next(err, morph1, morph2);
              });
          }

          function doDiff(m1, m2, next) {
            lively.ide.diffNonInteractiveMorphScripts(
              m1,
              m2,
              function (err, diff) {
                next(err);
      ...
      "lively.ide.openGitControl": {
        description: "tools: open GitControl",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          $world.openGitControl();
          return true;
        },
      },
      ...
      "lively.ide.git.commit": {
        ...
        exec: function () {
          lively.ide.git.Interface.gitCommit({}, function (err, cmd) {
            ...
            msgMorph.setStatusMessage(
              err ? String(err) : lively.lang.obj.values(cmd).join("\n"),
            );
          });
          return true;
        },
      ...
      "lively.ide.git_blame": {
        ...
        exec: function () {
          ...
          function openGitBlame(file) {
            var relative = new window.URL(
              "file://" + file.path,
            ).relativePathFrom(new window.URL("file://" + base));
            var ed = createEd();
          ...
          function createEd() {
            ...
            ed.addScript(function gitBlame() {
              return window.System.get(
                window.System.decanonicalize("git-blame"),
              );
            });

            ed.addScript(function onKeyDown(evt) {
              if (
                this.aceEditor.getKeyboardHandler().$iSearch ||
                this.aceEditor.getKeyboardHandler().isOccurHandler
              )
                return;
              ...
              switch (keyString) {
                ...
                // Annotate the revision indicated by the current line.
                case "Shift-J":
                  this.gitBlame().queryAnnotateRevIn(this);
                  break;
                ...
                case "F":
                  this.gitBlame().showContentOfVersionAtLine(this);
                  break;
                ...
                // changed in the file.
                case "D":
                  this.gitBlame().showDiffOfVersionAtLine(this);
                  break;
                ...
                // changed in the tree.
                case "Shift-D":
                  this.gitBlame().showDiffOfAllFilesOfVersionAtLine(this);
                  break;
                ...
                case "L":
                  this.gitBlame().showLogOfVersionAtLine(this);
                  break;
        ...
        exec: function (args) {
          lively.lang.fun.composeAsync(
            ...
            function (n) {
              ...
              $world.prompt(
                "Browse issues of repository:",
                function (input) {
                  n(null, input);
                },
                {
                  input: "LivelyKernel/LivelyKernel",
                  historyId: "apis.Github.Issues.browse-issues-repo",
                },
              );
            },
            function (repoName, n) {
            ...
            err && $world.inform("Error: " + (err.stack || err));
          });
          return true;
        },
      },
          ...
          var open = {
            ...
            exec: function (candidate) {
              if (!candidate.isDirectory) {
                lively.ide.commands.byName["lively.ide.openTextEditor"].exec(
                  candidate.path,
                );
              } else if (candidate.isDirectory) {
                lively.ide.commands.byName["lively.ide.openDirViewer"].exec(
                  candidate.path,
                );
              }
            },
      ...
      "lively.ide.openPresentationController": {
        description: "open presentation controller",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          ...
          $world.prompt(
            ...
            function (url) {
              ...
              lively.morphic.World.loadInIFrameWithWindow(
                url,
                $world.visibleBounds().insetByPt(pt(300, 200)),
              ).comeForward();
            },
      ...
      "lively.Config.openPreferences": {
        description: "customize user preferences and config options",
        exec: function () {
          $world.openPreferences();
          return true;
        },
      },
        ...
        exec: function () {
          $world.prompt(
            ...
            function (input) {
              var url;
              try {
                url = String(new URL(input));
              } catch (e) {
                show("%s is not a valid URL", input);
                return;
              }
              JSLoader.removeAllScriptsThatLinkTo(
                url,
              ); /*load even if loaded before*/
              JSLoader.loadJs(url);
            },
            {
              input: "http://lively-web.org/say-hello.js",
              historyId: "lively.net.loadJavaScriptFile",
            },
          );
        },
      },
      ...
      // lively-2-lively
      "lively.net.lively2lively.openWorkspace": {
        description: "open Lively2LivelyWorkspace",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          lively.require("lively.net.tools.Lively2Lively").toRun(function () {
            lively
              .BuildSpec("lively.net.tools.Lively2LivelyWorkspace")
              .createMorph()
              .openInWorldCenter()
              .comeForward();
          });
      ...
      "lively.net.tools.openLively2LivelyInspector": {
        description: "open Lively2Lively inspector",
        isActive: lively.ide.commands.helper.noCodeEditorActive,
        exec: function () {
          lively.require("lively.net.tools.Lively2Lively").toRun(function () {
            lively
              .BuildSpec("lively.net.tools.Lively2LivelyInspector")
              .createMorph()
              .openInWorldCenter()
              .comeForward();
          });
              ...
              actions: [
                {
                  ...
                  exec: function (candidate) {
                    withSelectedSessionDo
                      ...
                      : lively.net.tools.Functions.openWorkspaceForSession(
                          candidate,
                        );
                  },
                },
                  ...
                  exec: function (candidate) {
                    ...
                    $world
                      .addCodeEditor({
                        ...
                        content: sessions
                          .map(lively.net.tools.Functions.printSession)
                          .join("\n\n"),
                        textMode: "text",
                        extent: pt(600, 500),
                      })
      ...
      "lively.ide.debugging.globalTrace": {
        ...
        exec: function () {
          lively.require("lively.Tracing").toRun(function () {
            var tracersInstalled =
                lively.Tracing && lively.Tracing.stackTracingEnabled,
              globalTracingEnabled =
                tracersInstalled && lively.Tracing.globalTracingEnabled;
    ...
    Object.extend(lively.ide.commands.defaultBindings, {
      // bind commands to default keys
      "lively.morphic.World.save": {
        mac: ["Command-S", "cmd-s-l s a v e"],
        win: "Control-S",
      },
      "lively.ide.openSystemCodeBrowser": {
        mac: "Command-B",
      ...
      "lively.morphic.Window.gather": {
        mac: "cmd-s-l s t a c k w",
        win: "ctrl-s-l s t a c k w",
      },
      "lively.morphic.Window.rename": {
        mac: "cmd-s-l r e n",
        win: "ctrl-s-l r e n",
      ...
      "lively.ide.findFile": {
        mac: ["Control-X F", "Control-X Control-F"],
        win: ["Control-X F", "Control-X Control-F"],
      },
      ...
      "lively.ide.codeSearch": {
        mac: ["Command-Shift-C", "Command-Shift-F"],
        win: ["Control-Shift-C", "Control-Shift-G", "Control-Shift-F"],
      },
      ...
      "lively.morphic.World.undoLastAction": {
        mac: ["Command-Z", "cmd-z-l u n d o"],
        win: "Control-Z",
      },
      "lively.morphic.World.redoNextAction": {
        mac: ["Command-Y", "cmd-y-l r e d o"],
        win: "Control-Y",
      },
