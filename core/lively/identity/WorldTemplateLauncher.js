 ...
 *
 * Only "shop" is implemented — WorldsBrowser.js's template picker never sends
 * any other key (gallery/movie/books/game are rendered as inert placeholders
 * there), so no other case is needed yet.
 */
