...
Object.extend(lively.LexicalEditor = {}, {
  ...
  createEditor: function(containerElement, config) {
    ...
    const unregisterUpdateListener = editor.registerUpdateListener(
      function({ editorState, dirtyElements, dirtyLeaves, prevEditorState, tags }) {
        if (config.onUpdate) {
          config.onUpdate({
    ...
    return {
      ...
      registerCommand: function(command, handler, priority) {
        return this._editor.registerCommand(command, handler, priority || 0);
      },
       ...
       */
      isFocused: function() {
        return this._editor.getRootElement()
