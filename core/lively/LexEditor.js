module("lively.LexEditor")
  .requires(
    "lively.LexicalEditor",
    "lively.LexicalToolbar",
    "lively.LexicalCollaboration",
  )
  .toRun(function () {
    /**
     * LexEditor
    ...
    Object.extend((lively.LexEditor = {}), {
      ...
      initializeEditor: function (containerElement, options) {
        ...
        const editorContentElement = containerElement.querySelector(
          "#lex-editor-content",
        );
        const editorRootElement =
          containerElement.querySelector("#lex-editor-root");
        const toolbarPlaceholder = containerElement.querySelector(
          "#lex-toolbar-placeholder",
        );
        const statusBar =
          containerElement.querySelector('[style*="Ready"]').parentElement;
        ...
        const lexicalEditor = lively.LexicalEditor.createEditor(
          editorRootElement,
          editorConfig,
        );
        ...
        // Create toolbar
        const toolbar = lively.LexicalToolbar.createToolbar(
          lexicalEditor,
        ...
        if (options.collaborationEnabled) {
          const collabOptions = Object.extend(
            {
              documentId:
                options.documentId ||
                "lexeditor-doc-" + Math.random().toString(36).substr(2, 9),
              userId:
                options.userId ||
          ...
          lively.LexicalCollaboration.setupCollaboration(
            lexicalEditor,
            collabOptions.documentId,
            collabOptions,
          );
        }
