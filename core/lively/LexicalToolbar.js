    ...
    Object.extend((lively.LexicalToolbar = {}), {
      ...
      createToolbar: function (lexicalEditor, options) {
        ...
        toolbar.style.cssText =
          options.toolbarStyle || this._getDefaultToolbarStyle();
        ...
        groups.forEach(
          function (group) {
            ...
            groupDiv.style.cssText =
              "display: inline-block; margin-right: 8px; padding: 0 4px; border-right: 1px solid #ccc;";
      ...
      _createButton: function (config, lexicalEditor) {
        ...
        btn.style.cssText =
          "padding: 6px 8px; margin: 2px; background: #f0f0f0; border: 1px solid #999; border-radius: 3px; cursor: pointer; font-size: 11px; font-weight: bold;";
        btn._config = config;
        btn._active = false;
