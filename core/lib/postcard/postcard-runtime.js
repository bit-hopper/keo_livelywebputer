...
${reason}`);
  ...
  var y_prosemirror_exports = {};
  __export(y_prosemirror_exports, {
  ...
  var initProseMirrorDoc = (yXmlFragment, schema) => {
    ...
    return { doc: doc4, meta, mapping: meta.mapping };
  };
  ...
  function prosemirrorJSONToYDoc(schema, state, xmlFragment = "prosemirror") {
    const doc4 = Node.fromJSON(schema, state);
  ...
  // postcard-runtime-entry.js
  window.Y = yjs_exports;
  window.WebsocketProvider = WebsocketProvider;
  window.yProsemirror = y_prosemirror_exports;
  window.PM = {
    model: dist_exports,
    state: dist_exports2,
    view: dist_exports3,
    commands: dist_exports4,
    keymap: dist_exports5,
    schemaList: dist_exports6
  };
})();
